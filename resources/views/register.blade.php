			...
			<div id="loginbox" style="margin-top:130px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
				<div class="panel panel-info" >
					...
					<div style="padding-top:30px" class="panel-body" >
						...
						@endif
						<form id="loginform" class="form-horizontal" role="form" method="post" action="{{url('/register')}}">
							{{ csrf_field() }}
							...
							<div style="margin-bottom: 25px" class="input-group">
								...
								<input id="confirm-password" type="password" class="form-control" name="pas" placeholder="Confirm Password">
							</div>
							...
							<div style="margin-top:10px" class="form-group">
								...
								<div class="col-sm-12 controls">
									<button id="btn-register" type="submit" class="btn btn-warning btn-fill" style="width: 100%;">
										<a href="{{url('/register')}}"></a> Register  
									</button>
								</div>
							</div>
						</form>
